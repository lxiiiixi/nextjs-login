...
export default function Register({ handleLogin }) {
    ...
    const signUp = () => {
        if (password && email) {
            axios.post("./api/user", { userPwd: password, userName: email })
                .then(res => {
                    if (res.data.success) {
                        alert("Success! Username:" + res.data.data.userName)
                        handleLogin()
                    } else {
            ...
            <div className="mx-auto">
                ...
                <div action="" className="mt-6 mb-0 space-y-4 rounded-lg p-8 shadow-2xl">
                    ...
                    <div className="text-center text-sm text-gray-500">
                        ...
                        <span className="underline" onClick={handleLogin}> Sign In</span>
                    </div>
                </div>
            </div>
        </div>
